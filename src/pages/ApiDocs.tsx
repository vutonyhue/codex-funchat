...
const endpoints = {
  chat: [
    { method: "GET", path: "/v1/conversations", description: "List all conversations (SDK only)" },
    { method: "GET", path: "/v1/conversations/:id", description: "Get a specific conversation (SDK only)" },
    { method: "POST", path: "/v1/conversations", description: "Create a new conversation (SDK only)" },
    { method: "GET", path: "/v1/conversations/:id/messages", description: "Get messages in a conversation (SDK only)" },
    { method: "POST", path: "/v1/conversations/:id/messages", description: "Send a message (SDK only)" },
    { method: "DELETE", path: "/v1/messages/:id", description: "Delete a message (SDK only)" },
  ],
  users: [
  ...
  calls: [
    { method: "POST", path: "/v1/calls", description: "Start a call (SDK only)" },
    { method: "PATCH", path: "/v1/calls/:id", description: "Update call status (SDK only)" },
    { method: "GET", path: "/v1/calls/history", description: "Get call history (SDK only)" },
    { method: "GET", path: "/v1/calls/:id", description: "Get call details (SDK only)" },
  ],
  crypto: [
