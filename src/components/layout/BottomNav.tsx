import { MessageCircle, Phone, Wallet, Settings, User } from 'lucide-react';
...
interface BottomNavProps {
  activeTab: 'chat' | 'calls' | 'settings' | 'profile';
  onTabChange: (tab: 'chat' | 'calls' | 'settings' | 'profile') => void;
  callBadge?: number;
}
